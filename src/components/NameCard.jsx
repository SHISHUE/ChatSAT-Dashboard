  ...
  return (
    <div className={`mx-[1vw] lg:mx-[0.5vw] flex justify-between items-center my-[0.3rem] px-[1.5vw] py-[1.1vw] rounded lg:rounded-xl cursor-pointer shadow-inner-2xl text-[1vw] text-[#f8f8f8] bg-gradient-to-b ${
      ...
      <div className="flex gap-1 items-center ">
        <p className="lg:text-[1.2vw] text-[3vw] tracking-tighter text-[#ecff87] font-semibold">
          {id}.
        </p>
        <SlBadge className="lg:text-[1.2vw] text-[3vw] tracking-tighter text-[#ecff87] font-semibold" />
        <div className="lg:w-[1.2vw] lg:h-[1.2vw]  w-[2vw] h-[2vw] aspect-square rounded-full bg-[#d9d8d9]"></div>
       <p className="lg:text-[1.2vw] text-[3vw]">
       {name}
       </p>
      </div>

      <div>
        <h3 className="lg:text-[1.2vw] text-[3vw]">
